...
namespace EventEase.Controllers
{
    public class VenuesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,VenueName,VenueLocaiton,Imagegurl,Capacity")] Venue venue, IFormFile venueImage)
        {
            if (id != venue.VenueId)
            {
                return NotFound();
...
namespace EventEase.Controllers
{
    public class VenuesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("VenueId,VenueName,VenueLocaiton,Imagegurl,Capacity")] Venue venue)
        {
            if (ModelState.IsValid)
            {
                _context.Add(venue);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,VenueName,VenueLocaiton,Imagegurl,Capacity")] Venue venue)
        {
            if (id != venue.VenueId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var activeBookings = _context.Bookings.Any(b => b.VenueId == id && b.BookingDate >= DateTime.Now);
            if (activeBookings)
            {
